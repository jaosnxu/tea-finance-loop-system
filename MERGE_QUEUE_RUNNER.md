...
These defaults match this Loop system repository. Product repositories should pass their own protected check names with `--required-checks` when they differ.
